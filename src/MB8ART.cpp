...
namespace {
    // Anonymous namespace to prevent global symbol conflicts
    const EventBits_t localSensorAllUpdateBits = 
        mb8art::toUnderlyingType(mb8art::SensorUpdateBits::SENSOR1_UPDATE_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorUpdateBits::SENSOR2_UPDATE_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorUpdateBits::SENSOR3_UPDATE_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorUpdateBits::SENSOR4_UPDATE_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorUpdateBits::SENSOR5_UPDATE_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorUpdateBits::SENSOR6_UPDATE_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorUpdateBits::SENSOR7_UPDATE_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorUpdateBits::SENSOR8_UPDATE_BIT);

    const EventBits_t localSensorAllErrorBits = 
        mb8art::toUnderlyingType(mb8art::SensorErrorBits::SENSOR1_ERROR_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorErrorBits::SENSOR2_ERROR_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorErrorBits::SENSOR3_ERROR_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorErrorBits::SENSOR4_ERROR_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorErrorBits::SENSOR5_ERROR_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorErrorBits::SENSOR6_ERROR_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorErrorBits::SENSOR7_ERROR_BIT) |
        mb8art::toUnderlyingType(mb8art::SensorErrorBits::SENSOR8_ERROR_BIT);
}
...
MB8ART::MB8ART(uint8_t sensorAddress, const char* tag)
    ...
    // Create three separate event groups for clean separation (RYN4 pattern)
    xTaskEventGroup = xEventGroupCreate();
    xUpdateEventGroup = xEventGroupCreate();
    xErrorEventGroup = xEventGroupCreate();
    
    // Create separate event group for initialization bits
    ...
    if (!xTaskEventGroup || !xUpdateEventGroup || !xErrorEventGroup || 
        !xInitEventGroup || !initMutex || !interfaceMutex) {
    ...
    MB8ART_SRP_EVENT_GROUP_CLEAR_BITS(xUpdateEventGroup, 0x00FFFFFF);
    MB8ART_SRP_EVENT_GROUP_CLEAR_BITS(xErrorEventGroup, 0x00FFFFFF);
