...
Two example projects are included in the `example/` directory:

- **`example/simple/`** - Quick start example with minimal setup
- **`example/full/`** - Production-ready architecture with modular initialization

See [example/README.md](example/README.md) for details on which to use.

### FreeRTOS Task Manager Integration

The `example/full/` project demonstrates advanced usage with FreeRTOS task management:
